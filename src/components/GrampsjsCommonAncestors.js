...
export function personName(person) {
  if (!person) return ''
  // Honor the server-rendered display name (fixes name-format/comma quirks);
  // falls back to given+surname when name_display is absent.
  return personProfileDisplayName(person)
}
